...
exp_setup = {}
exp_setup['lat_cutoff'] = lat_cutoff_dict = {'tas':0.1,'psl':0.1,'zg':0.1,'tos':0.1,'sit':40,'sic':40}
...
save_folder = '/home/disk/kalman2/mkb22/SI_LIMs/sensitivity_testing/nvalid/'+folder_add
...
for i,yrvalid in enumerate(nyrs_valid):
...
#     for var in exp_setup['limvars']:
#         if var in ['sic','tos','sit']: 
#             mod_filename_dict[var] = ('_ntrunc'+str(nmodes_sic_list[0])+'_002_monthall_'+train_dsource+'_latcutoff_'+
#                                       str(exp_setup['lat_cutoff'][var])+'_wtTrue_dtTrue_ntrain_850_'+
#                                       str(yrend)+'_20211014_sqrtWt.pkl')
#         else: 
#             mod_filename_dict[var] = ('_ntrunc'+str(ntrunc)+'_002_monthall_cesm_lme_latcutoff_'+
#                                       str(exp_setup['lat_cutoff'][var])+'_wtTrue_dtTrue_ntrain_850_'+
#                                       str(yrend)+'_20211014_sqrtWt.pkl')
    for var in exp_setup['limvars']:
        mod_filename_dict[var] = ('_ntrunc'+str(nmodes_sic_list[0])+'_002_monthall_'+train_dsource+'_latcutoff_'+
...
#     exp_setup['mod_sic_filename'] = mod_sic_filename
    ...
    filename_end = (exp_setup['train_dsource']+'_ntrain'+exp_setup['mod_filename']['tas'][-22:-13]+'_'+
                    valid_dsource+'_validy_'+start_yr+'_'+end_yr+'_'+varsname+'_'+today_date+'_sqrtWt.pkl')
