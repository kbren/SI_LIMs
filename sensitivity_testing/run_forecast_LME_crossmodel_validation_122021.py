...
yrstart_list = [1] 
nyearsvalid_list = [164]

# LME settings (out of sample): 
#exp_setup['nyearsvalid'] = 64
...
for i,yrstart in enumerate(yrstart_list):
    exp_setup['nyears_startvalid'] = yrstart*12
    exp_setup['nyearsvalid'] = nyearsvalid_list[i]
...
#     LIMd = experiment_lme1['LIMd']
    ...
    filename_end = (exp_setup['train_dsource']+'_002_ntrain'+exp_setup['mod_filename']['tas'][-22:-13]+'_'+
                    valid_dsource+'_validy_'+start_yr+'_'+end_yr+'_'+varsname+'_'+today_date+'_2.pkl')
