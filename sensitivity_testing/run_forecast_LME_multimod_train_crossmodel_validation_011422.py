...
train_dsource = 'multimod_CESM2_MPI_GFDL_HadGEM3_hist'
# train_dsource = 'era5'
...
#valid_dsource = 'mpi_lm_kb'
#valid_dsource = 'cmip6_cesm2_hist_lmegrid'
#valid_dsource = 'mpi_lm_kb'
...
# lat_cutoff_dict = {'tas':40,'psl':40,'tos':40,'sic':40}
...
#exp_setup['limvars'] = ['tas','psl','tos','sic']
#exp_setup['limvars'] = ['tas','psl','tos','sic']
...
#yrstart = 49  # validation 1915-2015, 75 years of validation 

# LME settings (out of sample): 
#exp_setup['nyearsvalid'] = 200 #163
exp_setup['nyearsvalid'] = 200
exp_setup['nyearstrain'] = 624
...
#save_folder = '/home/disk/kalman2/mkb22/SI_LIMs/sensitivity_testing/nvalid_hist/mpi/'
save_folder = '/home/disk/kalman2/mkb22/SI_LIMs/sensitivity_testing/multimod/'
...
#                                       str(yrend)+'_20211014.pkl')
        mod_filename_dict[var] = ('_ntrunc_multimod_CESM2_MPI_GFDL_HadGEM3_monthall_'
                                  'latcutoff_40_wtTrue_dtTrue_ntrain_1850_2014_20211014.pkl')
#         mod_filename_dict[var] = ('_ntrunc50_Amon_monthall_multimod_MPI_GFDL_HadGEM3_CanESM_hist_latcutoff_'+
#                                   str(lat_cutoff_dict[var])+'_wtTrue_dtTrue_ntrain_1850_2473_20211014_sqrtWt.pkl')
    else: 
...
#     filename_lme1 = ('LIMcast_cesm_lme_002_ntrain_850_1650_validyrs_'+
...
filename_end = (exp_setup['train_dsource']+'_ntrain'+exp_setup['mod_filename']['tas'][-22:-13]+'_'+
