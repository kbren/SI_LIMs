...
nmodes_list = [5,10,15,20,30,40,50,60,70,80,90,100,150,200,250] # number of coupled EOFs for LIM state space (truncated-state space)
#nmodes = 25
...
for k, var in enumerate(limvars): 
    ...
    for n,ntrunc in enumerate(ntrunc_list):
        ...
        mod_data_trunc['var_expl_by_retained'] = var_expl_by_retained
